...
- `skills/`: reusable procedures. `.agents/skills` and `.claude/skills` are symlinks to the same files, kept visible outside a dot-folder so they can be reviewed in the vault.
